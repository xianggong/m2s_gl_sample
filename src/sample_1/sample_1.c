...
// Data for triangle 1
float vertices1[] = {   0.3f, 1.0f, 0.5f, 1.0f,
            2.7f, 0.85f, 0.0f, 1.0f,
            2.7f, 1.15f, 0.0f, 1.0f};
...
// Data for triangle 2
float vertices2[] = {  2.53f, 0.71f, 0.5f, 1.0f,
            1.46f, 2.86f, 0.0f, 1.0f,
            1.2f, 2.71f, 0.0f, 1.0f};
 
float colors2[] = { 0.0f, 1.0f, 0.0f, 1.0f,
            1.0f, 1.0f, 1.0f, 1.0f,
            1.0f, 1.0f, 1.0f, 1.0f};
 
 // Data for triangle 3
float vertices3[] = { 1.667f, 2.79f, 0.5f, 1.0f,
            0.337, 0.786f, 0.0f, 1.0f,
            0.597f, 0.636f, 0.0f, 1.0f};
 
float colors3[] = { 0.0f, 0.0f, 1.0f, 1.0f,
            1.0f, 1.0f, 1.0f, 1.0f,
            1.0f, 1.0f, 1.0f, 1.0f};
...
void renderScene(void)
{
	...
	setCamera(1.5,1.5,3.5,1.5,1.5,-3.5);
	glUseProgram(p);
	setUniforms();
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("GLSL Smooth Triangles Overlap");
